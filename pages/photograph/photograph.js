...
Page({
  ...
  data: {
	list:['晒单','搬家记','问答'],
	evaluate_list:[{"name":"准时达到"},{"name":"耐心细致"},{"name":"经验丰富"},{"name":"小心摆放"},{"name":"性价比高"}],
	orders:["2019 2 20  广州天河到美国"],
	new_select:0,
	images: [],
	fraction:0,
	evaluate_list_new:[],
  ...
  select_evaluate(e){
	  ...
	  if(select){
	   ...
	   console.log(this.data.evaluate_list_new)
  ...
  onLoad: function (options) { 
	  ...
	  // let list =this.data.evaluate_list
